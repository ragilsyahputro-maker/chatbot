...
def init_database():
    ...
    if cursor.execute("SELECT COUNT(*) FROM customers").fetchone()[0] == 0:
        ...
        cursor.executemany(
            ...
            [
                ("Arie Untung", "arieuntung@gmail.com", "08126794638", "Yogyakarta"),
                ("Samson", "samson@gmail.com", "081897384059", "Malang"),
                ("Terra", "terra@gmail.com", "085227356102", "Jakarta"),
                ("Silva", "silva@gmail.com", "087401115894", "Surabaya"),
                ("Charles", "charles@gmail.com", "081226805755", "Jakara")
            ]
        )
